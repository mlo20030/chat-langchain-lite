...
def build_agent():
    return create_agent(
        ...
        # No filesystem middleware — this is a chat surface; answers go in
        # the assistant message stream. AGENTS.md is already loaded at
        # import time via `get_prompt()` from Context Hub.
    )
